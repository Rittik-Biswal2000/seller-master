...
class mloc extends StatefulWidget {
  @override
  _mlocState createState() => _mlocState();
}
var v3,v4;
var latitude1,longitude1;
var plat,plon;
var mainloc;
class _mlocState extends State<mloc> {
  ...
  void initState() {
    ...
    storecoordinates(curlat1, curlon1);
    final marker = Marker(
        draggable: true,
        markerId: MarkerId("curr_loc"),
        // position: LatLng(21.5007,83.8994),

        position: LatLng(double.parse(curlat1),double.parse(curlon1)),
    ...
    _getAddressFromLatLng(double.parse(curlat1),double.parse(curlon1));
  }
          ...
          children: <Widget>[
            ...
            GoogleMap(
              ...
              initialCameraPosition: CameraPosition(
                ...
                target: LatLng(double.parse(curlat1),double.parse(curlon1)),
                zoom: 15.0,),
...
/*
  ...
  void Confirm() async{
    ...
    //print(latitude1);
    //print(longitude1);
    //Navigator.push(context, MaterialPageRoute(builder: (context)=> SellerRegister(first.addressLine,latitude1,longitude1)));
